<html>
<head>
	<title>Private Medical Dispensary Automation System</title>
	<link rel="shortcut icon" type="image/x-icon" href="images/hospital_favicon.ico" />
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="images/hospital_photo.jpg" alt=""/>
                        <h3><i>Welcome!</i></h3>   
                    </div>
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="index1.php">Login to an existing account</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="tel" minlength="10" maxlength="10" name="contact" class="form-control" placeholder="Phone "  />
                                        </div>
                                        <div class="form-group">
